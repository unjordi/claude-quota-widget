...
#   (c) las SKILLS genéricas (cerrar-slice, orquestar-fanout, checkpoint, rehidratar-hilo, turno-nocturno) de ~/.claude/skills/.
...
for sk in cerrar-slice orquestar-fanout checkpoint rehidratar-hilo turno-nocturno; do
